...
export default function DesignersClient({
  ...
  const handleFiltersChange = (filters: {
    ...
    if (filters.subcategory) filtered = filtered.filter(d => d.subcategory === filters.subcategory)
