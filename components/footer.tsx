...
import { getPageContentWithFallback } from "@/lib/page-content" // your helper
...
export async function Footer() {
  ...
  const { brand, company, social, newsletter, copyright } = content
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm">
              <Link href="/designers" className="text-muted-foreground hover:text-foreground">Designers</Link>
              <Link href="/events" className="text-muted-foreground hover:text-foreground">Events</Link>
              <Link href="/blog" className="text-muted-foreground hover:text-foreground">Blog</Link>
              <Link href="/coming-soon" className="text-muted-foreground hover:text-foreground">Shop</Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm">
              {company.links?.map((l: { label: string; url: string }, i: number) => (
                <Link
                  key={i}
                  href={l.url}
